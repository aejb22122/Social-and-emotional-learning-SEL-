...
# This has been verified in feburary 2019 ; there are no typos!
...
openxlsx::write.xlsx(table_all_TScores, file = "P:/RE/Private/SEL Assessment Results/DESSA Scoring/results/Post_Test/tscores_post_Test.xlsx")
file.exists("P:/RE/Private/SEL Assessment Results/DESSA Scoring/results/Post_Test/tscores_post_Test.xlsx")
