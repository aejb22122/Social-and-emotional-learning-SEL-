This is an R-Project for the analysis of the 2017-2018 DESSA (Post test)
The data has been downloaded on July 19, 2019, from SNAP Webhost:
...
In this project you will find the same structure of the pre-test. 

This set of R-Scripts computes the scores for the youth - for all the schools and generates two excel files with the results in a folder.
